...
Feature: Sitemap
  ...
  Scenario: The Sitemap contain the proper pages and not everything
    ...
    Then the sitemap should have 11 children
  ...
  Scenario: The Sitemap contains Basic Pages with adapted scoring and change frequency.
    Given I am on "/sitemap.xml"
    Then the XML element "//url[6]/loc" should contain "https://swissgames.garden/pages/about-us"
    Then the XML element "//url[6]/changefreq" should contain "yearly"
    Then the XML element "//url[6]/priority" should contain "0.7"

  Scenario: The Sitemap contains People with adapted scoring and change frequency.
    Given I am on "/sitemap.xml"
    Then the XML element "//url[7]/loc" should contain "https://swissgames.garden/people/jeremy-wuthrer-cuany"
    Then the XML element "//url[7]/changefreq" should contain "monthly"
    Then the XML element "//url[7]/priority" should contain "0.5"

  Scenario: The Sitemap contains Studios with adapted scoring and change frequency.
    Given I am on "/sitemap.xml"
    Then the XML element "//url[10]/loc" should contain "https://swissgames.garden/studios/giants-software"
    Then the XML element "//url[10]/changefreq" should contain "monthly"
    Then the XML element "//url[10]/priority" should contain "0.5"

  Scenario: The Sitemap contains the homepage with adapted scoring and change frequency.
    Given I am on "/sitemap.xml"
    Then the XML element "//url[11]/loc" should contain "https://swissgames.garden/"
    Then the XML element "//url[11]/changefreq" should contain "always"
    Then the XML element "//url[11]/priority" should contain "1.0"
