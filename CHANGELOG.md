...
- upgrade drupal/save_edit (1.10.0 => 2.1.0)
- upgrade cweagans/composer-patches (1.7.3 => 2.0.0)
- upgrade friendsofphp/php-cs-fixer (v3.75.0 => v3.92.5)
- update dependencies of phpdd
- update psalm dependencies
